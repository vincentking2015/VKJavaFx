...
import com.vk.control.tile.chart.SmoothedChart;
...
public class SmoothedChartTileSkin extends TileSkin {
    ...
    protected void initGraphics() {
        ...
        chartEventEventHandler = e -> tile.fireTileEvent(new TileEvent(TileEvent.EventType.SELECTED_CHART_DATA, new ChartData(e.getValue())));
