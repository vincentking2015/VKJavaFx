...
public class FluidTileSkin extends TileSkin {
    ...
    private TileEvent.EventType EventType;
    ...
    protected void handleCurrentValue(final double VALUE) {
        ...
        if (tile.getCustomDecimalFormatEnabled()) {
            valueText.setText(decimalFormat.format(clamp(minValue, maxValue, VALUE)));
        } else {
            valueText.setText(String.format(locale, formatString, clamp(minValue, maxValue, VALUE)));
        }
        ...
        if (tile.isFillWithGradient()) {
            ...
            for (Section section : tile.getSections()) {
                if (section.contains(clamp(minValue, maxValue, VALUE))) {
    ...
    protected void redraw() {
        ...
        if (tile.getCustomDecimalFormatEnabled()) {
            valueText.setText(decimalFormat.format(clamp(minValue, maxValue, tile.getCurrentValue())));
        } else {
            valueText.setText(String.format(locale, formatString, clamp(minValue, maxValue, tile.getCurrentValue())));
        }
