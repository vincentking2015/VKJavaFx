...
public class CountryTileSkin extends TileSkin {
    ...
    protected void initGraphics() {
        ...
        clickHandler = event -> tile.fireTileEvent(new TileEvent(TileEvent.EventType.SELECTED_CHART_DATA, new ChartData(country.getName(), country.getValue(), country.getColor())));
