...
public class GaugeSparkLineTileSkin extends TileSkin {
    ...
    protected void initGraphics() {
        ...
        enableNode(minValueText, tile.getMinValueVisible());

        maxValueText = new Text();
        enableNode(maxValueText, tile.getMaxValueVisible());
    ...
    protected void handleEvents(final String EVENT_TYPE) {
        ...
        if (EventType.VISIBILITY.name().equals(EVENT_TYPE)) {
            ...
            enableNode(valueText, tile.isValueVisible());
            enableNode(valueUnitFlow, !tile.getUnit().isEmpty());
            enableNode(timeSpanText, !tile.isTextVisible());
            enableNode(averageLine, tile.isAverageVisible());
            enableNode(averageText, tile.isAverageVisible());
            enableNode(stdDeviationArea, tile.isAverageVisible());
    ...
    private void setBar(final double VALUE) {
        ...
        double clampedValue = clamp(min, max, VALUE);
