...
public class BarChartItem extends Region implements Comparable<BarChartItem> {
    ...
    public BarChartItem(final String NAME, final double VALUE, final Instant TIMESTAMP, final Duration DURATION, final Color COLOR) {
        nameColor          = new ObjectPropertyBase<Color>(Tile.FOREGROUND) {
            ...
            @Override
            public Object getBean() { return BarChartItem.this; }
            @Override
        ...
        barBackgroundColor = new ObjectPropertyBase<Color>(Color.rgb(72, 72, 72)) {
            @Override
            protected void invalidated() { barBackground.setFill(get()); }
            @Override
            public Object getBean() { return BarChartItem.this; }
            @Override
            public String getName() { return "barBackgroundColor"; }
        };
        formatString       = "%.0f";
        locale             = Locale.US;
        maxValue           = 100;
    ...
    @Override
    public int compareTo(final BarChartItem ITEM) { return Double.compare(getValue(), ITEM.getValue()); }
