...
import com.vk.control.tile.events.IndicatorEvent;
    ...
    public ObjectProperty<Color> ringColorProperty() {
        if (null == ringColor) {
            ringColor = new ObjectPropertyBase<Color>(_ringColor) {
                @Override
                public Object getBean() { return Indicator.this; }
                @Override
                public String getName() { return "ringColor"; }
            };
            _ringColor = null;
        }
        return ringColor;
    ...
    public ObjectProperty<Color> dotOnColorProperty() {
        if (null == dotOnColor) {
            dotOnColor = new ObjectPropertyBase<Color>(_dotOnColor) {
                ...
                public Object getBean() { return Indicator.this; }
                @Override
                public String getName() { return "dotOnColor"; }
            };
            _dotOnColor = null;
        }
        return dotOnColor;
    ...
    public ObjectProperty<Color> dotOffColorProperty() {
        if (null == dotOffColor) {
            dotOffColor = new ObjectPropertyBase<Color>(_dotOffColor) {
                ...
                public Object getBean() { return Indicator.this; }
                @Override
                public String getName() { return "dotOffColor"; }
            };
            _dotOffColor = null;
        }
        return dotOffColor;
    ...
    public BooleanProperty onProperty() {
        if (null == on) {
            on = new BooleanPropertyBase(_on) {
                @Override
                protected void invalidated() { fireEvent(get() ? INDICATOR_ON : INDICATOR_OFF); }
                @Override
                public Object getBean() { return Indicator.this; }
                @Override
