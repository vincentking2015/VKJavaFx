 ...
 */
package com.vk.control.tile.addons;
...
public class HappinessIndicator extends Region {
    ...
    public HappinessIndicator(final Happiness HAPPINESS, final double VALUE) {
        happiness          = new ObjectPropertyBase<>(HAPPINESS) {
            ...
            @Override
            public Object getBean() { return HappinessIndicator.this; }
            @Override
            public String getName() { return "happiness"; }
        };
        ...
        textColor          = new ObjectPropertyBase<>(Tile.FOREGROUND) {
            @Override
            protected void invalidated() { text.setFill(get()); }
            @Override
            public Object getBean() { return HappinessIndicator.this; }
            @Override
        ...
        happyColor         = new ObjectPropertyBase<>(Tile.GREEN) {
            ...
            public Object getBean() { return HappinessIndicator.this; }
            @Override
            public String getName() { return "happyColor"; }
        };
        neutralColor       = new ObjectPropertyBase<>(Tile.YELLOW_ORANGE) {
            ...
            public Object getBean() { return HappinessIndicator.this; }
            @Override
            public String getName() { return "neutralColor"; }
        };
        unhappyColor       = new ObjectPropertyBase<>(Tile.RED) {
            ...
            public Object getBean() { return HappinessIndicator.this; }
            @Override
            public String getName() { return "unhappyColor"; }
        };
        initGraphics();
        registerListeners();
    }
