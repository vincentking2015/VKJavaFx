...
import com.vk.control.tile.tools.TreeNode;
...
public class SunburstChartBuilder<B extends SunburstChartBuilder<B>> {
    ...
    public final B visibleData(final SunburstChart.VisibleData VISIBLE_DATA) {
        properties.put("visibleData", new SimpleObjectProperty(VISIBLE_DATA));
        return (B)this;
    }

    public final B textOrientation(final SunburstChart.TextOrientation ORIENTATION) {
    ...
    public final SunburstChart build() {
        ...
        for (String key : properties.keySet()) {
            if ("prefSize".equals(key)) {
                ...
                CONTROL.setVisibleData(((ObjectProperty<SunburstChart.VisibleData>) properties.get(key)).get());
            } else if ("textOrientation".equals(key)) {
                CONTROL.setTextOrientation(((ObjectProperty<SunburstChart.TextOrientation>) properties.get(key)).get());
