...
import com.vk.control.tile.events.SmoothedChartEvent;
import com.vk.control.tile.tools.Helper;
import com.vk.control.tile.tools.Point;
    ...
    public BooleanProperty smoothedProperty() {
        if (null == smoothed) {
            smoothed = new BooleanPropertyBase(_smoothed) {
                @Override
                protected void invalidated() { layoutPlotChildren(); }
                @Override
                public Object getBean() { return SmoothedChart.this; }
                @Override
                public String getName() { return "smoothed"; }
            };
        }
        return smoothed;
    }
    ...
    public ObjectProperty<ChartType> chartTypeProperty() {
        if (null == chartType) {
            chartType = new ObjectPropertyBase<ChartType>(_chartType) {
                ...
                public Object getBean() { return SmoothedChart.this; }
                @Override
                public String getName() { return "chartType"; }
            };
            _chartType = null;
        }
        return chartType;
    ...
    public IntegerProperty subDivisionsProperty() {
        if (null == subDivisions) {
            subDivisions = new IntegerPropertyBase(_subDivisions) {
                ...
                public Object getBean() { return SmoothedChart.this; }
                @Override
                public String getName() { return "subDivisions"; }
            };
        }
        return subDivisions;
    }
    ...
    public BooleanProperty snapToTicksProperty() {
        if (null == snapToTicks) {
            snapToTicks = new BooleanPropertyBase(_snapToTicks) {
                ...
                public Object getBean() { return SmoothedChart.this; }
                @Override
                public String getName() { return "snapToTicks"; }
            };
        }
        return snapToTicks;
    }
    ...
    public BooleanProperty symbolsVisibleProperty() {
        if (null == symbolsVisible) {
            symbolsVisible = new BooleanPropertyBase(_symbolsVisible) {
                @Override
                protected void invalidated() { getData().forEach(series -> setSymbolsVisible(series, _symbolsVisible)); }
                @Override
                public Object getBean() { return SmoothedChart.this; }
                @Override
    ...
    public ObjectProperty<Color> selectorFillColorProperty() {
        if (null == selectorFillColor) {
            selectorFillColor = new ObjectPropertyBase<Color>(_selectorFillColor) {
                ...
                public Object getBean() { return SmoothedChart.this; }
                @Override
                public String getName() { return "selectorFillColor"; }
            };
    ...
    public ObjectProperty<Color> selectorStrokeColorProperty() {
        if (null == selectorStrokeColor) {
            selectorStrokeColor = new ObjectPropertyBase<Color>(_selectorStrokeColor) {
                ...
                public Object getBean() { return SmoothedChart.this; }
                @Override
                public String getName() { return "selectorStrokeColor"; }
            };
    ...
    public DoubleProperty selectorSizeProperty() {
        if (null == selectorSize) {
            selectorSize = new DoublePropertyBase(_selectorSize) {
                @Override
                protected void invalidated() { set(Helper.clamp(1, 20, get())); }
                @Override
                public Object getBean() { return SmoothedChart.this; }
                @Override
                public String getName() { return "selectorSize"; }
            };
        }
        return selectorSize;
    }
