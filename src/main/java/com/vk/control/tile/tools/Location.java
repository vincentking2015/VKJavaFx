...
import com.vk.control.tile.events.LocationEventListener;
...
public class Location {
    ...
    // ******************** Constructors **************************************
    public Location() {
        this(0, 0, 0, Instant.now(), "", "", Tile.TileColor.BLUE.color);
    }
    public Location(final double LATITUDE, final double LONGITUDE) {
        this(LATITUDE, LONGITUDE, 0, Instant.now(), "", "", Tile.TileColor.BLUE.color);
    }
    public Location(final double LATITUDE, final double LONGITUDE, final String NAME) {
        this(LATITUDE, LONGITUDE, 0, Instant.now() ,NAME, "", Tile.TileColor.BLUE.color);
    }
    ...
    public Location(final double LATITUDE, final double LONGITUDE, final String NAME, final String INFO) {
        this(LATITUDE, LONGITUDE, 0, Instant.now() ,NAME, INFO, Tile.TileColor.BLUE.color);
    }
