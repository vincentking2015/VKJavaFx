...
import com.vk.control.tile.events.TreeNodeEvent;
import com.vk.control.tile.events.TreeNodeEventListener;
...
public class TreeNode<T> {
    private final TreeNodeEvent PARENT_CHANGED   = new TreeNodeEvent(TreeNode.this, TreeNodeEvent.EventType.PARENT_CHANGED);
    private final TreeNodeEvent          CHILDREN_CHANGED = new TreeNodeEvent(TreeNode.this, TreeNodeEvent.EventType.CHILDREN_CHANGED);
    private final TreeNodeEvent          CHILD_ADDED      = new TreeNodeEvent(TreeNode.this, TreeNodeEvent.EventType.CHILD_ADDED);
    private final TreeNodeEvent          CHILD_REMOVED    = new TreeNodeEvent(TreeNode.this, TreeNodeEvent.EventType.CHILD_REMOVED);
    private T                            item;
