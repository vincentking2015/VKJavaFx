...
import static com.vk.core.javafx.helper.LayoutHelper.iconView;
...
//		newStage.setMaximized(false);
    ...
    public static void setControllerOnCloseRequest(Object controller, Event event) {
        try {
            ...
            LogUtil.error("执行onCloseRequest方法失败"+e);
        }
    }
    ...
    public static void setSpinnerValueFactory(Spinner spinner, Number min, Number max, Number initialValue,
        ...
        if (min instanceof Integer) {
            SpinnerValueFactory.IntegerSpinnerValueFactory secondStart_0svf = new SpinnerValueFactory.IntegerSpinnerValueFactory((int) min, (int) max,
            ...
            spinner.getEditor().textProperty().addListener((observable, oldValue, newValue) -> {
                try {
                    ...
                    LogUtil.warn("数字int转换异常 newValue:" + newValue);
                    spinner.getEditor().setText(oldValue);
                }
            });
        } else if (min instanceof Double) {
            SpinnerValueFactory.DoubleSpinnerValueFactory secondStart_0svf = new SpinnerValueFactory.DoubleSpinnerValueFactory((double) min, (double) max,
            ...
            spinner.getEditor().textProperty().addListener((observable, oldValue, newValue) -> {
                try {
                    ...
                    LogUtil.warn("数字double转换异常 newValue:" + newValue);
                    spinner.getEditor().setText(oldValue);
                }
            });
        }
