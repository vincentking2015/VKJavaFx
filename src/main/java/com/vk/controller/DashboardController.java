...
import com.vk.control.tile.*;
import com.vk.control.tile.Tile.ImageMask;
import com.vk.control.tile.Tile.MapProvider;
import com.vk.control.tile.Tile.SkinType;
import com.vk.control.tile.Tile.TileColor;
import com.vk.control.tile.addons.HappinessIndicator;
import com.vk.control.tile.addons.HappinessIndicator.Happiness;
import com.vk.control.tile.addons.Indicator;
...
import com.vk.control.tile.colors.Dark;
import com.vk.control.tile.events.TileEvent.EventType;
import com.vk.control.tile.icons.Flag;
...
import com.vk.view.DashboardView;
...
import static com.vk.Main.RESOURCE_BUNDLE;
 ...
 * #                                                   #
 */
public class DashboardController extends DashboardView {
...
//    }
    ...
    public static FXMLLoader getFXMLLoader() {
        URL url = DashboardController.class.getResource("/com/vk/fxml/Dashboard.fxml");
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        imageTile = TileBuilder.create()
                ...
                .prefSize(TILE_WIDTH, TILE_HEIGHT)
                .title("Image Tile")
                .image(new Image(DashboardController.class.getResourceAsStream("/com/vk/control/tile/HanSolo.png")))
