...
import com.vk.model.ToolFxmlLoaderConfiguration;
import com.vk.plugin.PluginManager;
import com.vk.service.IndexService;
import com.vk.service.index.PluginManageService;
import com.vk.service.index.SystemSettingService;
import com.vk.utils.Config;
import com.vk.view.IndexView;
...
import static com.vk.utils.Config.Keys.NotepadEnabled;
...
public class IndexController extends IndexView {
    ...
    public static FXMLLoader getFXMLLoader() {
        URL url = IndexController.class.getResource("/com/vk/fxml/Index.fxml");
    ...
    private void aboutAction() {
        FxAlerts.info("提示",bundle.getString("aboutText") + Config.xJavaFxToolVersions);
    }
